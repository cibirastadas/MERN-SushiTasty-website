    ...
    return (
        <div className={classes.HomeAboutCover}>
            <div className={classes.description}>
                ...
                <p className={classes.aboutUs}>SushiFresh - japoniško maisto restoranas. Vieta kur galima paragauti aukščiausio lygio patiekalų</p>
                <div>
                    <p className={classes.aboutMore}>Plačiau apie mus skaitykite</p>
                    <Button linkTo="/about"cName={{btnColor: "btnBlack"}}>Apie mus</Button>
                </div>
            </div>
        </div>
    );
